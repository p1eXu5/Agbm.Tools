...
namespace Agbm.NpoiExcel.Tests.UnitTests
{
    ...
    public class TypeRepositoryUnitTests
    {
        ...
        public void TryGetPropertyMap_TypeValid_ReturnsPropertyMap ()
        {
            ...
            var res = TypeRepository.TryGetPropertyMap( sheetTable, type, out _ );
        ...
        class TestType3
        {
            public static readonly string[] HiddenlessPropertyNames = {
            ...
            public static readonly string[] WithHiddenPropertyNames = {
